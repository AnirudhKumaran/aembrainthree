...
@Model(adaptables = SlingHttpServletRequest.class, adapters = Singlebook.class)
public class SinglebookImpl implements Singlebook{
	private static final Logger LOG = LoggerFactory.getLogger(SinglebookImpl.class);
